...
namespace GuildrunAccess.Tests
{
    public class GraphAnnouncerTests
    {
        ...
        {
            // The group is ON the child's chain AND is the from-node: the prefix swallows it.
        ...
        public void ExpandedStateWordAppendsToGroups()
        {
            ...
            try
            {
                ...
                group.Vtable.SpeaksOwnExpansion = true; // nodes that carry their own state word
