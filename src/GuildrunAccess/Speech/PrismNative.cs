...
namespace GuildrunAccess.Speech
{
    /// <summary>
    /// Thin P/Invoke layer over prism.dll (https://github.com/ethindp/prism), a unified native
    /// abstraction over screen readers / TTS (NVDA, JAWS, SAPI, OneCore, ...). Hand-written P/Invoke
    /// against the native dll, which sits next to Guildrun.exe and talks to the screen reader itself.
    /// </summary>
