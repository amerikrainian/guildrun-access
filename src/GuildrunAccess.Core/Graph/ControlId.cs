...
namespace GuildrunAccess.Core.Graph
{
    ...
    ///
    /// <para><b>Reference</b> (optional) is the game/domain object a node was derived from (a view, a
    /// component, an item), compared by reference identity. <b>StructuralKey</b> (always present) is a
    ...
    /// dictionary key. The reference tier is metadata, applied explicitly during focus reconciliation via
    /// <see cref="ReferenceMatches"/>.</para>
    /// </summary>
