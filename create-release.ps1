...
# The installer finds the mod zip by the asset name pattern GuildrunAccess-v<maj>.<min>.<patch>.zip
...
$zipPath = Join-Path $releaseDir "GuildrunAccess-$VersionTag.zip"
$installerPath = Join-Path $releaseDir "GuildrunAccessInstaller.exe"
