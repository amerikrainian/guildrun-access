...
# releases\GuildrunAccessInstaller.exe. Needs cargo and libclang (the wxWidgets
...
$targetExe = Join-Path $installerDir "target\release\guildrun-access-installer.exe"
$outputExe = Join-Path $releaseDir "GuildrunAccessInstaller.exe"
